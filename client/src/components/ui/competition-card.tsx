...
export function CompetitionCard({ competition }: CompetitionCardProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col h-full border border-gray-200 relative transition-transform duration-200 hover:scale-[1.01]">
      {/* Image - square aspect ratio */}
      <Link href={competitionUrl} className="block cursor-pointer">
